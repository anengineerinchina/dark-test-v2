                        ...
                        bool* pfMissingInputs)
{
    ...
    if (fCheckInputs)
    {
		...
		if (tx.vin.size() == 1 && tx.vout.size() == 1)
			if (tx.vout[0].nValue == .1 || tx.vout[0].nValue == .5 || tx.vout[0].nValue == 1 || tx.vout[0].nValue == 5 || tx.vout[0].nValue == 10 || tx.vout[0].nValue == 50 || tx.vout[0].nValue == 100 || tx.vout[0].nValue == 500 || tx.vout[0].nValue == 1000) //teleport denominations
				isTeleport = true;
