    ...
    const CBlockIndex* pindexBlock, bool fBlock, bool fMiner)
{
    ...
    if (!IsCoinBase())
    {
		...
		//bitcoindark: value checks for teleport/multisig fees
			...
			if ((double)COIN/vout[0].nValue == .1 || (double)COIN/vout[0].nValue == .5 || (double)COIN/vout[0].nValue == 1 || (double)COIN/vout[0].nValue == 5 || (double)COIN/vout[0].nValue == 10 || (double)COIN/vout[0].nValue == 50 || (double)COIN/vout[0].nValue == 100 || (double)COIN/vout[0].nValue == 500 || (double)COIN/vout[0].nValue == 1000) //teleport denominations
            isTeleport = true;
