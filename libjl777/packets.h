...
int32_t add_random_onionlayers(char *hopNXTaddr,int32_t numlayers,char *verifiedNXTaddr,uint8_t *final,uint8_t **srcp,int32_t len)
{
    char destNXTaddr[64];
    uint8_t bufs[2][4096],*dest,*src = (*srcp);
