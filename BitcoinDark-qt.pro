...
LIBS += $$PWD/src/leveldb/libleveldb.a $$PWD/src/leveldb/libmemenv.a $$PWD/src/libjl777.a $$PWD/src/libothers.a $$PWD/src/libwebsockets.a $$PWD/src/libsodium.a $$PWD/src/libuv.a $$PWD/src/curllib.lib -lz -lm
...
LIBS += $$join(BOOST_LIB_PATH,,-L,) $$join(BDB_LIB_PATH,,-L,) $$join(LEVELDB_LIB_PATH,,-L,) -lleveldb  $$join(OPENSSL_LIB_PATH,,-L,) $$join(QRENCODE_LIB_PATH,,-L,)
LIBS += -lssl -lcrypto -ldb_cxx-4.8$$BDB_LIB_SUFFIX
